...
- [`preparar-agenda`](skills/preparar-agenda/GUIDE.md): Prepara conversas com uma startup cruzando a conversa da reunião no Granola com os indicadores do portfolioOS. Use para analisar a última reunião, preparar agenda, call ou 1:1, e para decidir o que acompanhar ou cobrar da investida.
- [`apresentacao-portfolio`](skills/apresentacao-portfolio/GUIDE.md): Monta a Análise Crítica mensal do Corporate Venture — o deck que o fundo já apresenta hoje — cruzando os números do portfolioOS com as conversas do mês no Granola, gerando o spec e construindo o .pptx pela skill brq-pptx. Use para análise crítica, deck, apresentação, slides ou material de comitê e de reunião de sócios sobre o portfólio.
